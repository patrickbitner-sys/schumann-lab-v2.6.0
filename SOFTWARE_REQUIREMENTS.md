...
* **Ambient Echo** – Tone-free ambience mode.  The tonal carrier path is muted, and only ambience/chord content is heard.  Ambient Echo adds delayed stereo taps to the soundscape layers (ocean/rain/birds/waves) to create a gently immersive, low-fatigue field.
